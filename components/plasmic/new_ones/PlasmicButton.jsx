...
import sty from "./PlasmicButton.module.css"; // plasmic-import: InkiWn_hJlV/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: C3f3FgCnH9VKtI/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: bbY45N8hXda0bx/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__bpauB)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__lwTio)}
                role={"img"}
              />
            ),
