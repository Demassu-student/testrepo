...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: Pk_l4MGMb4hjYx/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__r0CzB)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___0Cco8)}
              />
            </React.Fragment>
          ),
