...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: 8ceOxyfszem3bX/component
import Select__Option from "../../Select__Option"; // plasmic-import: ewAEVwmcISj0Qb/component
import NavMenuItemBase from "../../NavMenuItemBase"; // plasmic-import: JjbA4Hm8LNdr-g/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic_new_ones.module.css"; // plasmic-import: 578p2KiWp3ZSUFPY7FrhK3/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: 3Vr7VM3BiE8vGJ/css
import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: QNsqKKyBgmqOWl/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: DBFrcOSImv4MRC/icon
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: true ? (
                  <Select__Option
                    className={classNames("__wab_instance", sty.option___7KrG)}
                    value={"value1"}
                  >
                    {"Option 1"}
                  </Select__Option>
              ...
              <NavMenuItemBase
                className={classNames(
                  "__wab_instance",
                  sty.navMenuItemBase__lQarC,
                  {
                    [sty.navMenuItemBaseisOpen__lQarCqjb35]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    )
              ...
              <NavMenuItemBase
                className={classNames(
                  "__wab_instance",
                  sty.navMenuItemBase___7DBm3,
                  {
                    [sty.navMenuItemBaseisOpen___7DBm3Qjb35]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    )
              ...
              <NavMenuItemBase
                className={classNames(
                  "__wab_instance",
                  sty.navMenuItemBase__e5Su,
                  {
                    [sty.navMenuItemBaseisOpen__e5Suqjb35]: hasVariant(
                      variants,
                      "isOpen",
                      "isOpen"
                    )
